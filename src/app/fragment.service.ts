...
this.fragments.push(new Fragment(userService.chef,
      ...
      `<p>Je me retourne, <strong class="people">SOLDAT</strong> a déjà ouvert la <strong class="mc">mallette</strong> contenant la bombe. Je ne me souviens pas de ce genre de design. Il y a beaucoup plus de fils que d’habitude et aucun cadran. J’ajoute:</p>
...
<p><strong class="people">CHEF</strong> est envoyé en arrière, j’amortis sa chute. Apparement il n’a pas autant l’habitude que moi de côtoyer des <strong class="mc">explosions</strong>.</p>
...
<p>“- comme vous vous en doutez, on a une nouvelle <strong class="mc">mission</strong>. Mais celle là a l’air particulièrement délicate est dangereuse.”</p>
<p>“- Vous étiez donc à nouveau auprès d’un contact hier ? C’était elle ?” demande <strong class="people">SOLDAT</strong></p>
<p>“- Non, ce n’était pas elle. Des <strong class="mc">Psycheïdes</strong>&nbsp;je crois. Ils sont en panique et on a juste 1 mois pour se préparer.”</p>
`, 5));
this.fragments.push(new Fragment(userService.erudit,
      ["commando","comando"],
...
this.fragments.push(new Fragment(userService.erudit,
      ["thyrapoedae"],
      `★ “I know kung fu” ★`,
      `<p>En lisant ce chapitre un <strong class="mc">pouvoir</strong> s’insinue en moi. Je sais maintenant comment on crée des portails !</p>
`, 14));
this.fragments.push(new Fragment(userService.erudit,
      ["planmagiepouvoir"],
...
<p>Et tout d’un coup plein de <strong class="mc">bagues</strong> et de colliers en or apparaissent devant elle, sur l’étoile.</p>
...
this.fragments.push(new Fragment(userService.journalist,
      ...
      `<p>Bureau Mer</p>
<p>Reserve</p>
<p>Cabinet <strong class="mc">Oiseau</strong></p>
<p>Lavoir</p>
<p>Terrasse</p>
...
this.fragments.push(new Fragment(userService.journalist,
      ["panda"],
      `Panda`,
      `<p>Bureau <strong class="mc">Afrique</strong></p>
<p>Chambre Roi</p>
<p>Grenier</p>
<p>Hall</p>
<p>Cave</p>
...
<p>“- Bonjour, je passe juste voir <strong class="people">VOYANTE</strong>. Ça fait longtemps, et je lui ai apporté des <strong class="mc">sucreries</strong>.”</p>
...
<p>Il faut que j’aille sur place, je ne fais pas confiance aux humains. Je trouverais forcément dans le châteaux des documents indiquant où est <strong class="mc">Maria</strong> est tenu captive !</p>
`, 7));
this.fragments.push(new Fragment(userService.monstre,
      ["fiole"],
      `Caen, Bar - Ce midi - Le briefing`,
